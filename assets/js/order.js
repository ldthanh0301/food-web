                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <div>
                                ...
                                <input style="width: 100px;" type='text' value="${product.MSHH}" name="MSHH" min='1' max="${product.totalQuantity}" readonly/>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h6>Số lượng sản phẩm</h6>
                                            <input data-index="${index}" onchange='handleChangeQuantity(this)' class="form-control" name='quantity' type="number" value='${product.quantity}'>
                                    </div>
                                    <div class="col-6">
                                        <h6>Thành tiền</h6>
